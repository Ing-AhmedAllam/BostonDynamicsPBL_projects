...
def fast(images: list):
    ...
    for ind, image in enumerate(images):
        ...
        keys_n_descriptors.append(keypoints)
...
def draw_matches(image1, image2, keypoints1, keypoints2, good_matches):
    image_matches = cv2.drawMatches(image1, keypoints1, image2, keypoints2, good_matches[:30], None, flags=cv2.DrawMatchesFlags_NOT_DRAW_SINGLE_POINTS)
...
if __name__ == '__main__':
    ...
    keys_n_descriptors = fast([image, image2])
